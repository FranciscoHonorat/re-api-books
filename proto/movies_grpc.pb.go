...
const (
	...
	MovieService_ListMovie_FullMethodName   = "/movies.MovieService/ListMovie"
...
type MovieServiceClient interface {
	...
	ListMovie(ctx context.Context, in *ListMovieRequest, opts ...grpc.CallOption) (*ListMovieResponse, error)
...
func (c *movieServiceClient) ListMovie(ctx context.Context, in *ListMovieRequest, opts ...grpc.CallOption) (*ListMovieResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListMovieResponse)
	err := c.cc.Invoke(ctx, MovieService_ListMovie_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MovieServiceServer interface {
	...
	ListMovie(context.Context, *ListMovieRequest) (*ListMovieResponse, error)
...
func (UnimplementedMovieServiceServer) ListMovie(context.Context, *ListMovieRequest) (*ListMovieResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListMovie not implemented")
}
...
func _MovieService_ListMovie_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListMovieRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MovieServiceServer).ListMovie(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MovieService_ListMovie_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MovieServiceServer).ListMovie(ctx, req.(*ListMovieRequest))
	}
	return interceptor(ctx, in, info, handler)
}
